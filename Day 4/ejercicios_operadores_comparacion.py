"""EJERCICIO 1: Crea dos variables (num1 y  num2) con los valores 36 y 17 respectivamente. 
...
"""EJERCICIO 2: Crea dos variables (num1 y  num2):
...
"""EJERCICIO 3: Crea dos variables (num1 y  num2):
