"""EJERCICIO 1: Crea tres variables (num1 ,  num2 y num3):
...
"""EJERCICIO 2: Crea tres variables (num1 ,  num2 y num3):
Dentro de num1, almacena el valor 36
Dentro de num2, almacena el resultado de la operación 72/2
Dentro de num3, almacena el valor 48
...
"""EJERCICIO 3: Verifica si las palabras almacenadas en las siguientes variables:
palabra1 = "éxito", y
palabra2 = "tecnología"
...
mi_bool = (palabra1 not in frase) or (palabra2 not in frase)